...
let HttpAgent;
let Actor;
let Ed25519KeyIdentity;
let Principal;
let IDL;
// Lazy load @dfinity packages
let dfinityLoadPromise = null;
    ...
    dfinityLoadPromise = (async () => {
        try {
            const [agent, identity, principal, candid] = await Promise.all([
                Promise.resolve().then(() => __importStar(require("@dfinity/agent"))),
                Promise.resolve().then(() => __importStar(require("@dfinity/identity"))),
                Promise.resolve().then(() => __importStar(require("@dfinity/principal"))),
                Promise.resolve().then(() => __importStar(require("@dfinity/candid"))),
            ]);
...
const icpIdl = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        store_round_snapshot: IDL.Func([IDL.Nat8, IDL.Nat64, IDL.Nat16, IDL.Vec(RoundPlayerSnapshotInput), IDL.Bool, IDL.Opt(IDL.Text)], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
        get_current_config_version: IDL.Func([], [IDL.Text], ["query"]),
        set_current_config_version: IDL.Func([IDL.Text], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
        // Chunk-based seed API (Merkle tree) - season_id removed, round IDs are globally unique per tier
        reveal_seed_for_round: IDL.Func([IDL.Nat8, IDL.Nat64], // tier_id, round_id
        [IDL.Variant({ Ok: SeedProofIDL, Err: IDL.Text })], []),
        generate_and_store_chunk: IDL.Func([IDL.Nat8, IDL.Nat64], // tier_id, chunk_id
        [IDL.Variant({ Ok: IDL.Nat64, Err: IDL.Text })], []),
        regenerate_chunk: IDL.Func([IDL.Nat8, IDL.Nat64], // tier_id, chunk_id
        [IDL.Variant({ Ok: IDL.Nat64, Err: IDL.Text })], []),
        refresh_chunks_for_tier: IDL.Func([IDL.Nat8, IDL.Nat64], // tier_id, round_id
        ...
        chunk_exists: IDL.Func([IDL.Nat8], // tier_id only
        [IDL.Bool], ["query"]),
        get_chunk_size: IDL.Func([], [IDL.Nat64], ["query"]),
        get_revealed_seed: IDL.Func([IDL.Nat8, IDL.Nat64], // tier_id, round_id
        [IDL.Opt(SeedProofIDL)], ["query"]),
        ...
        get_player_round_history: IDL.Func([IDL.Vec(IDL.Nat8), IDL.Nat64, IDL.Nat64], [IDL.Variant({ Ok: PlayerRoundHistoryPage, Err: IDL.Text })], ["query"]),
        // Engine config functions
        add_engine_config: IDL.Func([IDL.Text, IDL.Text], // version, config_json
        [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
        get_engine_config: IDL.Func([IDL.Text], // version
        [IDL.Opt(EngineConfigIDL)], ["query"]),
        get_latest_engine_config: IDL.Func([], [IDL.Opt(EngineConfigIDL)], ["query"]),
        get_latest_engine_config_version: IDL.Func([], [IDL.Opt(IDL.Text)], ["query"]),
        list_engine_config_versions: IDL.Func([], [IDL.Vec(EngineConfigIDL)], ["query"]),
        // Player join data functions
        store_player_join_data: IDL.Func([PlayerJoinDataInputIDL], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
        get_player_join_data: IDL.Func([IDL.Vec(IDL.Nat8), IDL.Nat8, IDL.Nat64], // player, tier_id, round_id
        [IDL.Variant({ Ok: IDL.Opt(PlayerJoinDataIDL), Err: IDL.Text })], ["query"]),
        get_round_join_data: IDL.Func([IDL.Nat8, IDL.Nat64], // tier_id, round_id
        [IDL.Vec(PlayerJoinDataOutputIDL)], ["query"]),
        get_player_round_seed: IDL.Func([IDL.Nat8, IDL.Nat64, IDL.Vec(IDL.Nat8)], // tier_id, round_id, player
        [IDL.Variant({ Ok: IDL.Vec(IDL.Nat8), Err: IDL.Text })], ["query"]),
        // Player config v2 functions (quantized, with commitment hash)
        set_player_config: IDL.Func([PlayerConfigInputIDL], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
        get_player_config: IDL.Func([IDL.Nat64, IDL.Nat8, IDL.Vec(IDL.Nat8)], // round_id, tier_id, player_config_hash
        [IDL.Variant({ Ok: IDL.Opt(PlayerConfigOutputIDL), Err: IDL.Text })], ["query"]),
        list_player_configs: IDL.Func([IDL.Nat64, IDL.Nat8], // round_id, tier_id
        [IDL.Variant({ Ok: IDL.Vec(PlayerConfigOutputIDL), Err: IDL.Text })], // Admin only - returns Result
        ["query"]),
        list_player_configs_if_revealed: IDL.Func([IDL.Nat64, IDL.Nat8], // round_id, tier_id
...
class ICPModule {
     ...
     */
    async revealSeedForRound(tierId, roundId) {
        await this.ensureInitialized();
        try {
            const result = await this.actor.reveal_seed_for_round(tierId, BigInt(roundId));
            if ("Err" in result) {
            ...
            return {
                ...
                proof_siblings: proof.proof_siblings.map((s) => new Uint8Array(s)),
     ...
     */
    async getRevealedSeed(tierId, roundId) {
        await this.ensureInitialized();
        try {
            const result = await this.actor.get_revealed_seed(tierId, BigInt(roundId));
     ...
     */
    async generateAndStoreChunk(tierId, chunkId) {
        await this.ensureInitialized();
        try {
            const result = await this.actor.generate_and_store_chunk(tierId, BigInt(chunkId));
            if ("Err" in result) {
     ...
     */
    async regenerateChunk(tierId, chunkId) {
        await this.ensureInitialized();
        try {
            const result = await this.actor.regenerate_chunk(tierId, BigInt(chunkId));
            if ("Err" in result) {
     ...
     */
    async refreshChunksForTier(tierId, roundId) {
        await this.ensureInitialized();
        try {
            const result = await this.actor.refresh_chunks_for_tier(tierId, BigInt(roundId));
            if ("Err" in result) {
     ...
     */
    async getRoundSeed(roundId, tierId = 0) {
        try {
     ...
     */
    async getRoundSeedWithSignature(roundId, tierId = 0) {
        try {
            const proof = await this.getRevealedSeed(tierId, roundId);
            if (!proof)
                return null;
     ...
     */
    async getLastSettledRound(tierId) {
        await this.ensureInitialized();
        try {
     ...
     */
    async storeRoundSnapshot(tierId, roundId, seasonId, players, didEmit = false, emitTxSig) {
        await this.ensureInitialized();
        try {
            const result = await this.actor.store_round_snapshot(tierId, BigInt(roundId), seasonId, players.map(p => ({
            ...
            })), didEmit, emitTxSig ? [emitTxSig] : [] // Candid Opt encoding
            );
            if ("Err" in result) {
     ...
     */
    async setCurrentConfigVersion(version) {
        await this.ensureInitialized();
        try {
     ...
     */
    async getRoundSnapshot(tierId, roundId) {
        await this.ensureInitialized();
        try {
     ...
     */
    async getRoundSnapshotsByTier(tierId, offset, limit) {
        await this.ensureInitialized();
        try {
            return await this.actor.get_round_snapshots_by_tier(tierId, BigInt(offset), BigInt(limit));
        }
        catch (error) {
     ...
     */
    async getPlayerRoundHistory(playerPubkey, offset, limit) {
        await this.ensureInitialized();
        try {
            if (playerPubkey.length !== 32) {
                throw new Error('Player pubkey must be 32 bytes');
            }
            const result = await this.actor.get_player_round_history(Array.from(playerPubkey), BigInt(offset), BigInt(limit));
            if ("Err" in result) {
     ...
     */
    async getLatestEngineConfigVersion() {
        await this.ensureInitialized();
        try {
     ...
     */
    async listEngineConfigVersions() {
        await this.ensureInitialized();
        try {
     ...
     */
    async addEngineConfig(version, configJson) {
        await this.ensureInitialized();
        try {
     ...
     */
    async getPlayerJoinData(player, tierId, roundId) {
        await this.ensureInitialized();
        try {
            const result = await this.actor.get_player_join_data(Array.from(player), tierId, BigInt(roundId));
            if ("Err" in result) {
     ...
     */
    async getRoundJoinData(tierId, roundId) {
        await this.ensureInitialized();
        try {
     ...
     */
    async getPlayerRoundSeed(tierId, roundId, player) {
        await this.ensureInitialized();
        try {
            const result = await this.actor.get_player_round_seed(tierId, BigInt(roundId), Array.from(player));
            if ("Err" in result) {
     ...
     */
    async listPlayerConfigs(roundId, tierId) {
        await this.ensureInitialized();
        try {
     ...
     * @returns Array of player config records
     */
    async listPlayerConfigsIfRevealed(roundId, tierId) {
        await this.ensureInitialized();
        try {
     ...
     */
    static encodeRoundKey(tierId, roundId) {
     ...
     */
    static decodeRoundKey(roundKey) {
     ...
     */
    static hexToSignature(hexSignature) {
     ...
     */
    static constructChunkRootMessage(tierId, chunkId, merkleRootHex) {
     ...
     */
    static createIdentityFromSecretKey(secretKey) {
